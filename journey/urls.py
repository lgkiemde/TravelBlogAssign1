...
urlpatterns = [
                  ...
                  # path('password_reset/done/', auth_views.PasswordResetDoneView.as_view(template_name="registration/password_change_done.html"), name="password_reset_done"),
                  ...
                  path('logout', auth_views.LogoutView.as_view(template_name="registration/logged_out.html"),
                       name="logged_out"),
                  path('changepassword', views.changepass, name='password_change_form'),
